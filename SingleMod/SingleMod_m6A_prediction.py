...
def main():
	...
	parser.add_argument('-g','--gpu',type=int,default=0,required = False, help="cuda index, default is 0; if do not have/use GPU, ignore this setting")
	...
	try:
		motif_extra = np.memmap(args.npy_dir + "/" + args.motif + "_extra.npy", mode='r', dtype="<U70")
