...
def main():
	...
	parser.add_argument('-p','--process',type=int,default=4,required = False, help="the number of process; default setting is 8. This setting is dependent on the memory of your computer")
